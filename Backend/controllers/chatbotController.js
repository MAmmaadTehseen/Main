...
const knowledgeBase = [
  ...
  { keywords: ["ongoing", "completed", "project list", "all projects"], responseText: "To view all ongoing and completed projects, check the Projects section. For a comprehensive list of all department projects as of November 2025, refer to the project list document which includes project titles, supervisors, and team members.", pdfUrl: "/Ongoing and Completed Projects-13-11-2025.pdf" },
  { keywords: ["previous", "past", "completed projects", "finished"], responseText: "For information about previously completed FYP projects and ongoing projects, refer to the comprehensive project list updated as of November 13, 2025. This document contains details about all projects in the department.", pdfUrl: "/Ongoing and Completed Projects-13-11-2025.pdf" },

  // Advisor related
  { keywords: ["advisor", "supervisor", "find advisor", "contact advisor"], responseText: "You can find your advisor information in the Projects section - each project shows the assigned advisor. To contact your advisor, use the Discussion Board for your project. For more details on advisor workload and availability, check the PDF document.", pdfUrl: "/Advisor Workload For Spring 2026.pdf" },
  { keywords: ["search", "advisor", "list"], responseText: "Advisors are assigned to projects. You can see your project advisor in the Projects section. Each project displays the advisor's name and you can message them through the Discussion Board. View the advisor workload document for detailed information.", pdfUrl: "/Advisor Workload For Spring 2026.pdf" },
  { keywords: ["workload", "advisor workload", "capacity", "availability"], responseText: "For information about advisor workload, capacity, and availability for Spring 2026, please refer to the Advisor Workload document. This includes details about each advisor's current load and capacity for new projects.", pdfUrl: "/Advisor Workload For Spring 2026.pdf" },
